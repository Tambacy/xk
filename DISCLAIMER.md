...
- 但本软件需要统一身份认证凭据才能工作。请只在**你本人**的设备上运行，
  不用时通过界面上的「清除本机已保存的账号密码」清除凭据。

### 无担保

本软件按「现状」提供，不附带任何明示或暗示的担保。作者不保证本软件无缺陷、
不保证持续可用、不保证任何选课结果。学校系统随时可能改版，本项目可能失效
且不保证及时修复。

### 权利方如有异议

如果你是本项目所涉及系统的权利方，或认为本项目存在不当之处，请通过本仓库的
[Issues](../../issues) 或私密漏洞报告渠道联系。作者会立即配合处理，包括下架
仓库、删除发行版、调整说明措辞 —— **不需要任何前置程序**。
