...
> ## ⚠️ 使用前必读
>
> - 本项目是**个人学习项目**，与任何高校及其院系**没有任何关系**，
>   未获任何形式的授权或认可。本项目不代表任何机构。
...
| 文件 | 大小 | 说明 |
|---|---|---|
| `XkHelper-Setup-0.4.0.exe` | 334 MB | 安装包，推荐。自包含，装完即用 |
| `XkHelper-v0.4.0-source.zip` | 1473 KB | 源码，自行修改或构建用 |
...
# 产物：installer\XkHelper-Setup-0.4.0.exe（约 330 MB，自包含）
```
...
本项目是**个人学习项目**，与任何高校及其院系**没有任何关系**，未获授权。
