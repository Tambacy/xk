...
> ## ⚠️ 使用前必读
>
> - 本项目是**个人学习项目**，与学校及任何院系**没有任何关系**，
>   未获任何形式的授权或认可。名称中的「学校」仅用于说明适用场景。
> - 使用自动化工具选课**可能违反你所在学校的规定**，可能导致
>   **选课结果被取消、账号受限，甚至纪律处分**。请在确认学校允许后再使用。
> - **使用本软件的全部风险由你自行承担。** 作者不承担任何直接或间接责任。
> - 请合理设置监听间隔，不要给教务系统造成压力。
> - **禁止**商业用途（含收费代抢）、作为服务提供给他人、以及大规模分发安装包。
>
> 完整条款见 **[免责声明](DISCLAIMER.md)** 与 **[许可协议](LICENSE)**。
> 简单说：这是**个人学习项目，不是开源软件**，请自用、别外传、别商用。
...
| 文件 | 大小 | 说明 |
|---|---|---|
| `XkHelper-Setup-0.3.10.exe` | 334 MB | 安装包，推荐。自包含，装完即用 |
| `XkHelper-v0.3.10-source.zip` | 1480 KB | 源码，自行修改或构建用 |
...
# 产物：installer\XkHelper-Setup-0.3.10.exe（约 330 MB，自包含）
```
...
本项目是**个人学习项目**，与学校及任何院系**没有任何关系**，未获授权。
...
完整条款：**[免责声明](DISCLAIMER.md)** · **[许可协议](LICENSE)**
